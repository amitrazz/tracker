...
<div class="col col-lg-8">
        <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Roles and permission</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('role.store') }}">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="name" class="form-control" id="inputEmail3" placeholder=" Roles Name">
                        </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="display_name" class="form-control" id="inputEmail3" placeholder="Display name">
                      </div>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      @foreach ($permissions as $permission )
                       <label><input type="checkbox"  name="permission[ ]" value="{{$permission->id}}"> {{$permission->name}}<span></span></label>
                      @endforeach
                    </div>
                  </div>
                <!-- /.box-body -->
