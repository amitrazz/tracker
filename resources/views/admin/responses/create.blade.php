        ...
        <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('response.store') }}">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="name" id="inputState" class="form-control" placeholder="Response Name">
                      </div> 
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Response Code</label>
                    <div class="col-sm-8">
                      <input type="text" name="code" id="inputState" class="form-control" placeholder="Response Code">
                    </div> 
                </div>
                <div class="form-group">
